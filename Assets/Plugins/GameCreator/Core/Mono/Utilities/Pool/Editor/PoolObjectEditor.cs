namespace GameCreator.Pool
{
    ...
    public class PoolObjectEditor : Editor
    {
        ...
        {
            this.spInitCount = this.serializedObject.FindProperty(nameof(PoolObject.initCount));
            this.spDuration = this.serializedObject.FindProperty(nameof(PoolObject.duration));
        }
