...
namespace GameCreator.Behavior
{
    ...
    private void OnEnable()
		...
		{
			NodeRoot node = this.CreateNode<NodeRoot>((Node)parent);
		...
		{
			this.CreateNode<NodeComposite>((Node)parent);
		}

		public void CreateTask(object parent = null)
		{
			this.CreateNode<NodeTask>((Node)parent);
		}

        public void CreateDecorator(object parent = null)
        {
            this.CreateNode<NodeDecorator>((Node)parent);
        }

        public void CreateBehaviorGraph(object parent = null)
        {
            this.CreateNode<NodeBehaviorGraph>((Node)parent);
        }
		...
		private T CreateNode<T>(Node parent = null) where T : Node
		{
			...
			AssetDatabase.AddObjectToAsset(node, this.behaviorGraph);
